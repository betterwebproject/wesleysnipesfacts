  ...
  <xsl:template match="/">
    <html lang="en-US">
      <head>         
        ...
        <link rel="preload" fetchpriority="high" href="/assets/graphics/header_img.webp" as="image" type="image/webp"/>
